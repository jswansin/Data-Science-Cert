...
dropdown_options = [
    {'label': 'Report Type', 'value': 'Yearly Statistics'},
    {'label': 'Recession Period Statistics', 'value': 'disabled'}
]
# List of years 
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
        ...
        yearly_data = data[data['Year'] == (inptut_year)]
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, names='Vehicle_Type', values='Advertising_Expenditure',title='Advertising Expenditure Share by Vehicle Type'))
